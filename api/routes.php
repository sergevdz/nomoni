...
$expenses->get('/by-categories', 'getByCategories');
$expenses->get('/by-types', 'getByTypes');
$expenses->get('/by-payment-methods', 'getByPaymentMethods');
$expenses->get('/divided-by-months', 'getDividedByMonths');
