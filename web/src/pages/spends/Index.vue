                ...
                <template v-slot:body="props">
                  <q-tr :props="props">
                    ...
                    <q-td key="actions" :props="props">
                      <q-btn color="primary" icon="fas fa-edit" flat size="10px" @click="editSelectedRow(props.row.id)"/>
                      <q-btn color="primary" icon="fas fa-trash-alt" flat size="10px" @click="deleteSelectedRow(props.row.id)" />
                    </q-td>
                  </q-tr>
                </template>
