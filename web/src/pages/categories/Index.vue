<template>
  <q-page>
    <div class="q-pa-sm panel-header">
      <div class="row">
        <div class="col-sm-9">
          <span class="q-ml-md grey-8 fs28 page-title">Categories</span>
        </div>
        ...
        <div class="col q-pa-md">
          <div class="row q-mb-sm">
            <div class="col-sm-1 offset-11 pull-right">
              <q-btn color="primary" label="New" @click.native="$router.push('/categories/new')" />
            </div>
          </div>
  ...
  methods: {
    ...
    deleteSelectedRow (id) {
      this.$q.dialog({
        ...
        api.delete(`/categories/${id}`).then(({ data }) => {
          this.$q.dialog({
